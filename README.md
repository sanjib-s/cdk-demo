...
which contains an EC2 instace setup selecting one of the AMI, All required props for EC2 build, Amazon SQS queue that is subscribed to an Amazon SNS topic.
